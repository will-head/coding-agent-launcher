...
|----|--------|-------------|-----------|--------|
| [#2](https://github.com/will-head/coding-agent-launcher/pull/2) | create-pr/fix-screen-sharing | Implement clipboard sharing via tart-guest-agent | 2026-01-25 | Error handling: silent error suppression (3), missing dependency validation, hardcoded path |
