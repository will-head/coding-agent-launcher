...
|----|--------|-------------|-----------|--------|
| [#3](https://github.com/will-head/coding-agent-launcher/pull/3) | create-pr/project-scaffolding | Add project scaffolding for CAL CLI | 2026-01-31 | Dependency metadata issues (go.mod needs tidy) and empty init() function |
