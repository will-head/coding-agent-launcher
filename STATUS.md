...
|----|--------|-------------|-----------|--------|
| [#3](https://github.com/will-head/coding-agent-launcher/pull/3) | create-pr/project-scaffolding | Add project scaffolding for CAL CLI | 2026-01-31 | Empty internal/ dirs not tracked in git; AGENTS.md references wrong linter |
