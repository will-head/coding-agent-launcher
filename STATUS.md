...
|----|--------|-------------|----------|----------|
| [#10](https://github.com/will-head/coding-agent-launcher/pull/10) | create-pr/cache-clear | Add cache clear command with per-cache confirmation | Claude Opus 4.5 | 2026-02-04 |
