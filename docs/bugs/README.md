...
|----|---------|----------|--------|-----------|-------|--------|----------|
| [BUG-009](BUG-009-gh-repo-clone-lost-during-init.md) | gh repo clone during --init doesn't persist to snapshot | High | Resolved | Bootstrap | 0 (Bootstrap) | 2026-02-04 | 2026-02-04 |
