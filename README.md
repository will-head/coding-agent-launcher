...
> **Status:** Phase 0 (Bootstrap) Mostly Complete - 3 TODOs in 0.8, 6 new TODOs in 0.10 | Phase 1 (CLI Foundation) Not Started
...
- [VM Detection](docs/vm-detection.md) - How agents detect they're running in a VM
